...
import SelectLanguage from "@layouts/components/SelectLanguage";
  ...
  return (
    <header className="header sticky top-0 z-10">
      <nav className="navbar container">
        ...
        <div
          id="nav-menu"
          className={`order-3 ms-auto md:order-1 ${navOpen ? "max-h-[1000px]" : "max-h-0"
            }`}
        >
          <ul className="navbar-nav block w-full md:flex md:w-auto lg:space-x-2">
            ...
            {enable && (
              <li className="md:hidden">
                <Link className="btn btn-primary z-0" href={link} rel="">
                  {label}
                </Link>
              </li>
            )}
